...
do $$ begin
  create type report_status as enum ('received', 'payment_required', 'generating', 'generated', 'emailed', 'failed', 'review_requested', 'scoped', 'declined');
exception when duplicate_object then null;
end $$;
